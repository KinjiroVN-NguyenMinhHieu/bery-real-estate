...
$(document).ready(function () {
  ...
  //click read-more btn
  $("#read-more").click(() => callAPIGetFavouriteProperties(getAccessToken(), countRowTable() + gLimitRow));
});
...
function onPageLoading() {
  ...
  if (accessToken) {
    ...
    callAPIGetFavouriteProperties(accessToken, countRowTable() + gLimitRow);
...
function callAPIGetFavouriteProperties(paramAccessToken, paramSize) {
  //Khai báo xác thực ở headers
  let headers = {
    Authorization: "Bearer " + paramAccessToken
  };
  ...
  $.ajax({
      url: gAUTH_URL + "/favourite/limit?size=" + paramSize,
      method: "GET",
      headers: headers,
      success: function(paramData) {
