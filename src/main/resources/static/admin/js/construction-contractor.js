...
function createPage(paramPagenum) {
  ...
  callAPIGetAllConstructionContractors(vQueryParamsObj); 
}
...
function onIconApproveClick(paramIcon) {
  ...
  callAPIGetConstructionContractorsById(accessToken, gId);
}
  ...
  if (vCheck) {
    switch (gStatus) {
      case gStatusEnum.CREATE:
        callAPICreateAddress(accessToken, vLayoutObj);
        break;
      case gStatusEnum.UPDATE:
        callAPIUpdateAddress(accessToken, gId, vLayoutObj);
        break;
    }
  }
}
...
//Call API
function callAPIGetAllConstructionContractors(paramQueryObj) {
  ...
  $.ajax({
    url: gBASE_URL + "/construction-contractors?" + vQueryParams.toString(),
    headers: headers,
    method: "GET",
...
function callAPIGetConstructionContractorsById(paramAccessToken, paramId) {
  //Khai báo xác thực ở headers
  let headers = {
    Authorization: "Bearer " + paramAccessToken
  };
  ...
  $.ajax({
    url: gBASE_URL + "/construction-contractors/" + paramId,
    headers: headers,
    method: "GET",
...
function callAPICreateAddress(paramAccessToken, paramDataObj) {
  ...
  $.ajax({
    type: "POST",
    headers: headers,
    url: gBASE_URL + `/address-maps/${paramDataObj.addressId}/construction-contractors`,
...
function callAPIUpdateAddress(paramAccessToken, paramId, paramDataObj) {
  ...
  $.ajax({
    type: "PUT",
    headers: headers,
    url: gBASE_URL + `/address-maps/${paramDataObj.addressId}/construction-contractors/` + paramId,
    contentType: "application/json",
    data: JSON.stringify(paramDataObj),
    success: function (paramData) {
